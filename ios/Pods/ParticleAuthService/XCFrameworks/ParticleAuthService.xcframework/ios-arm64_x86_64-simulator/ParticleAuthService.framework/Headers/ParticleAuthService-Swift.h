...
typedef SWIFT_ENUM(NSInteger, EVMSignTypedDataVersion, open) {
  ...
  EVMSignTypedDataVersionV4Unique = 3,
};

typedef SWIFT_ENUM(NSInteger, ParticleAuthModalStyle, open) {
  ParticleAuthModalStylePageSheet = 0,
...
///
/// \param socialLoginPrompt Optional, social login prompt.
///
/// \param authorization Optional, LoginAuthorization object,
///
/// \param successHandler Success handler, user info.
///
/// \param failureHandler Failure handler.
///
+ (void)loginWithType:(enum LoginType)type account:(NSString * _Nullable)account supportAuthType:(NSArray<SupportAuthType *> * _Nonnull)supportAuthType socialLoginPrompt:(enum SocialLoginPrompt)socialLoginPrompt authorization:(LoginAuthorization * _Nullable)authorization successHandler:(void (^ _Nonnull)(UserInfo * _Nullable))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
/// Logout
...
/// On the Solana chain, strings in Base58 format are required; on the EVM chain, either hexadecimal strings starting with “0x” or human-readable strings are required.
///
/// \param successHandler Success handler, signature.
///
/// \param failureHandler Failure handler.
///
...
/// \param message Message that you want the user to sign.
/// On the EVM chain, either hexadecimal strings starting with “0x” or JSON strings are required.
///
...
/// Get user address, for evm, it is an eoa address.
///
/// returns:
/// Address
...
///
+ (void)setDisplayWallet:(BOOL)displayWallet SWIFT_DEPRECATED_MSG("The method is deprecated");
/// Open web wallet
/// \param styleJsonString Pass json string to control web style
///
+ (void)openWebWalletWithStyleJsonString:(NSString * _Nullable)styleJsonString;

...
export default class ConnectDemo extends PureComponent<ConnectScreenProps> {
  ...
  init = () => {
    ...
    ParticleInfo.projectId = '7a7e17de-769e-4c14-ab53-74f4bbbab2c5'; // 5479798b-26a9-4943-b848-649bb104fdc3
    ParticleInfo.clientKey = 'ceVobYxJWKIMreCfw4As26BiJe9tmAEA243BkRX2'; // cUKfeOA7rnNFCxSBtXE5byLgzIhzGrE4Y7rDdY4b
    ...
    const chainInfo: ChainInfo = AvalancheTestnet;
    const env = Env.Dev;
    const metadata = new DappMetaData(
      '7cc60584f92e577ce7ac435149f070d7',
      'BuddyGuard',
    ...
    this.newWeb3 = createWeb3(
      '7a7e17de-769e-4c14-ab53-74f4bbbab2c5',
      'cceVobYxJWKIMreCfw4As26BiJe9tmAEA243BkRX2',
